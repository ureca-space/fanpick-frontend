...
const createKblProfileImage = (kblId) =>
  `https://kbl.or.kr/files/kbl/players-photo/${kblId}.png`;

const createPlayer = (player) => {
  const imageCandidates = getUniqueValues([
    ...(player.imageCandidates || []),
    player.kboId ? createDaumKboProfileImage(player.kboId) : "",
    player.kblId ? createKblProfileImage(player.kblId) : "",
  ]);
...
const BASKETBALL_PLAYERS = [
  createPlayer({
    id: "heo-hoon",
    searchName: "Hoon Heo",
    wikipediaTitles: ["Heo Hoon", "허훈"],
    kblId: "291085",
    sport: "basketball",
    name: "허훈",
    englishName: "HEO HOON",
    position: "GUARD",
    introduction:
      "빠른 돌파와 창의적인 경기 운영으로 공격을 이끄는 대한민국 대표 가드.",
    tags: ["스피드", "돌파", "게임 리딩"],
    ratings: createRatings({
      돌파: 5,
      스피드: 5,
  ...
  createPlayer({
    ...
    position: "GUARD",
    introduction:
      "정교한 슈팅과 부드러운 공격 기술로 득점을 만들어내는 인기 가드.",
    tags: ["슈터", "득점력", "스타 플레이어"],
    ratings: createRatings({
      슈팅: 5,
      득점력: 5,
  ...
  createPlayer({
    id: "kim-sun-hyung",
    searchName: "Sun Hyung Kim",
    wikipediaTitles: ["Kim Sun-hyung", "김선형"],
    kblId: "290407",
    sport: "basketball",
    name: "김선형",
    englishName: "KIM SUN-HYUNG",
    position: "GUARD",
    introduction:
      "폭발적인 스피드와 화려한 돌파로 코트를 가르는 베테랑 포인트가드.",
    tags: ["플래시 썬", "속공", "화려한 돌파"],
    ratings: createRatings({
      스피드: 5,
      돌파: 5,
      속공: 5,
  ...
  createPlayer({
    ...
    sport: "basketball",
    name: "이정현",
    englishName: "LEE JUNG-HYUN",
    position: "GUARD",
    introduction: "과감한 공격과 높은 득점 생산 능력으로 경기를 주도하는 가드.",
    tags: ["득점 머신", "클러치", "공격 본능"],
    ratings: createRatings({
      득점력: 5,
      슈팅: 5,
      돌파: 4,
  ...
  createPlayer({
    id: "song-kyo-chang",
    searchName: "Kyo Chang Song",
    wikipediaTitles: ["Song Kyo-chang", "송교창"],
    kblId: "290897",
    sport: "basketball",
    name: "송교창",
    englishName: "SONG KYO-CHANG",
    position: "FORWARD",
    introduction:
      "뛰어난 운동 능력과 공수 균형을 바탕으로 다양한 역할을 수행하는 포워드.",
    tags: ["공수 겸장", "운동 능력", "멀티 포워드"],
    ratings: createRatings({
      운동능력: 5,
      수비: 5,
      돌파: 4,
  ...
  createPlayer({
    id: "choi-jun-yong",
    searchName: "Jun Yong Choi",
    wikipediaTitles: ["Choi Jun-yong", "최준용 (농구 선수)"],
    kblId: "290993",
    sport: "basketball",
    name: "최준용",
    englishName: "CHOI JUN-YONG",
    position: "FORWARD",
    introduction:
      "큰 신장과 넓은 시야를 활용해 공격 전개와 수비를 모두 책임지는 포워드.",
    tags: ["포인트 포워드", "넓은 시야", "멀티 플레이어"],
    ratings: createRatings({
      패스: 5,
      수비: 5,
      리바운드: 5,
  ...
  createPlayer({
    id: "ha-yoon-gi",
    searchName: "Yoon Gi Ha",
    wikipediaTitles: ["Ha Yoon-gi", "하윤기"],
    kblId: "291492",
    sport: "basketball",
    name: "하윤기",
    englishName: "HA YOON-GI",
    position: "CENTER",
    introduction:
      "높이와 기동력을 모두 갖추고 골밑에서 강한 존재감을 보여주는 센터.",
    tags: ["골밑 지배", "블록슛", "기동력"],
    ratings: createRatings({
      골밑득점: 5,
      리바운드: 5,
  ...
  createPlayer({
    id: "byun-jun-hyung",
    searchName: "Jun Hyung Byun",
    wikipediaTitles: ["Byun Jun-hyung", "변준형"],
    kblId: "291220",
    sport: "basketball",
    name: "변준형",
    englishName: "BYUN JUN-HYUNG",
    position: "GUARD",
    introduction:
      "강한 압박 수비와 빠른 공격 전개로 경기의 템포를 끌어올리는 가드.",
    tags: ["압박 수비", "스피드", "공격 전개"],
    ratings: createRatings({
      수비: 5,
      스피드: 5,
      패스: 4,
  ...
  createPlayer({
    id: "lee-woo-seok",
    searchName: "Woo Seok Lee",
    wikipediaTitles: ["Lee Woo-seok", "이우석 (농구 선수)"],
    imageCandidates: [
      "https://dimg.donga.com/wps/NEWS/IMAGE/2021/09/09/109164643.3.jpg",
    ],
    sport: "basketball",
    name: "이우석",
    englishName: "LEE WOO-SEOK",
    position: "FORWARD",
    introduction:
      "뛰어난 운동 능력과 적극적인 수비로 코트에 에너지를 더하는 포워드.",
    tags: ["에너지", "공수 전환", "운동 능력"],
    ratings: createRatings({
      운동능력: 5,
      수비: 5,
      속공: 5,
  ...
  createPlayer({
    id: "yang-hong-seok",
    searchName: "Hong Seok Yang",
    wikipediaTitles: ["Yang Hong-seok (basketball)", "양홍석"],
    kblId: "291091",
    sport: "basketball",
    name: "양홍석",
    englishName: "YANG HONG-SEOK",
    position: "FORWARD",
    introduction: "탄탄한 신체 조건과 외곽 공격력을 갖춘 균형 잡힌 포워드.",
    tags: ["공수 균형", "외곽 슈팅", "리바운드"],
    ratings: createRatings({
      슈팅: 4,
      리바운드: 5,
      수비: 4,
  ...
  createPlayer({
    id: "lee-hyun-jung",
    searchName: "Hyunjung Lee",
    wikipediaTitles: ["Hyunjung Lee", "이현중 (농구 선수)"],
    imageCandidates: [
      "https://davidsonwildcats.com/images/2021/10/20/BKC10_18_21_029.jpg",
    ],
    sport: "basketball",
    name: "이현중",
    ...
    position: "FORWARD",
    introduction:
      "큰 신장과 정확한 외곽슛을 바탕으로 공간을 넓혀주는 슈팅 포워드.",
    tags: ["장신 슈터", "외곽슛", "스페이싱"],
    ratings: createRatings({
      슈팅: 5,
      스페이싱: 5,
  ...
  createPlayer({
    id: "yeo-jun-seok",
    searchName: "Jun Seok Yeo",
    wikipediaTitles: ["Yeo Jun-seok", "여준석"],
    imageCandidates: [
      "https://storage.googleapis.com/goseattleu-com-prod/2025/10/08/0u9iaAXlVZmWB3t1H5gsQ9mx14bKEwzsfPVpz94j.jpg",
    ],
    sport: "basketball",
    name: "여준석",
    englishName: "YEO JUN-SEOK",
    position: "FORWARD",
    introduction:
      "강한 피지컬과 폭발적인 운동 능력으로 골밑과 속공에서 위력을 보여주는 포워드.",
    tags: ["피지컬", "덩크", "운동 능력"],
    ratings: createRatings({
      운동능력: 5,
      피지컬: 5,
